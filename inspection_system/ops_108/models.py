...
class OpsInspection(models.Model):
    vehicle = models.ForeignKey(Vehicle, on_delete=models.CASCADE, related_name='ops_108_inspections')
    inspector = models.ForeignKey(User, on_delete=models.CASCADE, related_name='ops_108_inspections')
    district = models.ForeignKey(District, on_delete=models.SET_NULL, null=True, blank=True, related_name='ops_108_district_inspections')
...
class InspectionCategory(models.Model):
    ...
    manager = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='managed_108_categories')
...
class Complaint(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='raised_108_complaints')
    ...
    category_manager = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='category_108_complaints')
    assignee = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_108_complaints')
